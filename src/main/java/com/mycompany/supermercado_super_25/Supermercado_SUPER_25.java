...
public class Supermercado_SUPER_25 {
    ...
    public static void main(String[] args) {
        ...
        int Acceso = 0;
        Productos producto[] = new Productos[20]; /// Creacion de array de objetos con 20(MAX) posiciones a modo de limitacion en arrays dinamicos en Java
        int SumaProductos=0;
        ...
        while (!MainMenuOption.equals(5)) {
            ...
            /// Conversion a entero de Opcion elegida e identificacion del caso al que aplica
                ...
                case "1":
                {
                    ...
                    while (masProductos!=2) {
                        ...
                        if(MenuProductoOpcion==1){
                            ...
                            /// Prevencion de pre-existencia del producto recorriendo los productos ya creados previamente
